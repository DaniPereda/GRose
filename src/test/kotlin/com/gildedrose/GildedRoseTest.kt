...
internal class GildedRoseTest {
    ...
    @Test
    fun `aged brie if sellIn less than 0 then increase quality`(){
        // GIVEN
    ...
    @Test
    fun `aged brie if sellIn less than 0 then increase quality if is not higher than 50`(){
        // GIVEN
    ...
    @Test
    fun `conjured sellIn greater 0 and quality greater 0`(){
        // GIVEN
        val items = arrayOf<Item>(Item("Conjured Mana Cake", 5, 7))
        val sut = GildedRose(items)
        // WHEN
        sut.updateQuality()
        // THEN
        ...
        assertEquals("Conjured Mana Cake", sut.items[0].name)
        assertEquals(4, sut.items[0].sellIn)
        assertEquals(5, sut.items[0].quality)
    }

    @Test
    fun `conjured sellIn equal 0 and quality equal 2`(){
        // GIVEN
        val items = arrayOf<Item>(Item("Conjured Mana Cake", 0, 2))
        val sut = GildedRose(items)
        // WHEN
        sut.updateQuality()
        // THEN
    ...
    @Test
    fun `conjured sellIn equal 0 and quality equal 5`(){
        // GIVEN
